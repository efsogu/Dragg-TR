...
const messages = {
  en: {
    ...
    "auth.nameTooLong": "Name must be 80 characters or fewer.",
    "auth.invalidCredentials": "Email or password is incorrect.",
    "auth.localeEnglish": "English",
    "auth.localePortuguese": "Portuguese",
    "auth.invalidEmail": "Enter a valid email address.",
    "auth.newPassword": "New password",
    "auth.oauthError": "Google sign-in could not be started.",
    ...
    "auth.resetPasswordError": "Password reset email could not be sent.",
    ...
    "auth.signUpDescription":
      "Create an account with your name, email, and password. You will get the same default categories and payment methods as Google sign-in.",
    "auth.signUpDisabled":
      "Email sign-up is disabled in Supabase. Enable the Email provider in the dashboard.",
    "auth.signUpError": "Account could not be created.",
    ...
    "dashboard.greeting.fallback": "Welcome back",
    ...
    "payments.invoiceAdvanceAmountRequired": "Enter an advance amount.",
    "payments.invoiceAdvanceAmountTooHigh":
      "The advance cannot be higher than the remaining invoice amount.",
    "payments.invoiceAdvanceConfirm": "Confirm advance",
    "payments.invoiceAdvanceDescription":
      "Create a transaction that pays part of this invoice now.",
    "payments.invoiceAdvanceError": "Failed to record invoice advance.",
    "payments.invoiceAdvanceSaving": "Recording...",
    "payments.invoiceAdvanceSuccess": "Invoice advance recorded successfully.",
    "payments.invoiceAdvanceTitle": "Invoice advance",
    "payments.invoicePaid": "Already paid",
    "payments.invoiceRemaining": "Remaining",
    "payments.invoiceTotal": "Original total",
    "payments.details.title": "Payment details",
    "payments.details.relatedPurchases": "Related purchases",
    "payments.details.noPurchases": "No purchases for this context.",
    "payments.details.total": "Total",
    "payments.details.paymentMethod": "Payment method",
    "payments.details.transactionDate": "Date",
    "payments.details.category": "Category",
    "payments.details.amount": "Amount",
    "payments.details.installment": "Installment",
    ...
    "transaction.invoiceAdvancePayment": "Invoice advance payment",
  ...
  "pt-BR": {
    ...
    "auth.emailAlreadyRegistered":
      "Este email já está cadastrado. Entre ou redefina sua senha.",
    "auth.email": "Email",
    "auth.emailRequired": "Informe seu email.",
    "auth.firstNameRequired": "Informe seu nome.",
    "auth.forgotPassword": "Esqueceu a senha?",
    "auth.genericError": "Algo deu errado. Tente novamente.",
    "auth.hidePassword": "Ocultar senha",
    "auth.nameTooLong": "O nome deve ter no máximo 80 caracteres.",
    "auth.invalidCredentials": "Email ou senha incorretos.",
    "auth.localeEnglish": "Inglês",
    "auth.localePortuguese": "Português",
    "auth.invalidEmail": "Informe um email válido.",
    "auth.newPassword": "Nova senha",
    "auth.oauthError": "Não foi possível iniciar o login com Google.",
    ...
    "auth.passwordHint":
      "Use pelo menos 8 caracteres com minúscula, maiúscula, número e símbolo.",
    "auth.passwordRequirementLowercase": "Uma letra minúscula",
    "auth.passwordRequirementMinLength": "Pelo menos 8 caracteres",
    "auth.passwordRequirementNumber": "Um número",
    "auth.passwordRequirementSymbol": "Um símbolo",
    "auth.passwordRequirements":
      "A senha deve incluir minúscula, maiúscula, número e símbolo.",
    "auth.passwordRequirementsTitle": "Sua senha deve incluir:",
    ...
    "auth.signIn": "Entrar",
    "auth.signInDescription": "Entre com Google ou com email e senha.",
    "auth.signInWithEmail": "Entrar com email",
    "auth.signUp": "Cadastrar",
    "auth.signUpDescription":
      "Crie uma conta com seu nome, email e senha. Você receberá as mesmas categorias e métodos de pagamento padrão do login com Google.",
    "auth.signUpDisabled":
      "Cadastro por email está desativado no Supabase. Habilite o provedor Email no painel.",
    "auth.signUpError": "Não foi possível criar a conta.",
    "auth.signUpWithEmail": "Cadastrar com email",
    "auth.weakPassword":
      "Senha muito fraca. Use pelo menos 8 caracteres com minúscula, maiúscula, número e símbolo.",
    "auth.updatePassword": "Atualizar senha",
    "auth.updatePasswordError": "Não foi possível atualizar a senha.",
    "auth.updatePasswordInstructions": "Escolha uma nova senha para sua conta.",
    ...
    "dashboard.greeting.fallback": "Bem-vindo de volta",
    ...
    "payments.invoiceAdvanceAmountRequired": "Informe o valor do adiantamento.",
    "payments.invoiceAdvanceAmountTooHigh":
      "O adiantamento não pode ser maior que o saldo restante da fatura.",
    ...
    "payments.invoicePaid": "Já pago",
    "payments.invoiceRemaining": "Restante",
    "payments.invoiceTotal": "Total original",
    "payments.details.title": "Detalhes do pagamento",
    "payments.details.relatedPurchases": "Compras relacionadas",
    "payments.details.noPurchases": "Nenhuma compra para este contexto.",
    "payments.details.total": "Total",
    "payments.details.paymentMethod": "Forma de pagamento",
    "payments.details.transactionDate": "Data",
    "payments.details.category": "Categoria",
    "payments.details.amount": "Valor",
    "payments.details.installment": "Parcela",
